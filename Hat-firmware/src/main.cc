...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, BACKUP_Pin|DROGUE_Pin|IMU_CS1_Pin|LED_STANDBY_Pin
                          |MEM_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, IMU_CS2_Pin|MEM_WP_Pin|MEM_HOLD_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BACKUP_CONT_Pin DROGUE_CONT_Pin RECOVERY_CONT_Pin RECOVERY_Pin
                           RADIO_DIO1_Pin MAG_INT_Pin */
  GPIO_InitStruct.Pin = BACKUP_CONT_Pin|DROGUE_CONT_Pin|RECOVERY_CONT_Pin|RECOVERY_Pin
                          |RADIO_DIO1_Pin|MAG_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : BACKUP_Pin DROGUE_Pin IMU_CS1_Pin LED_STANDBY_Pin
                           MEM_CS_Pin */
  GPIO_InitStruct.Pin = BACKUP_Pin|DROGUE_Pin|IMU_CS1_Pin|LED_STANDBY_Pin
                          |MEM_CS_Pin;
  ...
  /*Configure GPIO pins : IMU_CS2_Pin MEM_WP_Pin MEM_HOLD_Pin */
  GPIO_InitStruct.Pin = IMU_CS2_Pin|MEM_WP_Pin|MEM_HOLD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
