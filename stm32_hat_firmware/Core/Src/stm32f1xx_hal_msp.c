...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = IMU_SCK_Pin|IMUMOSI_Pin;
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    PB5     ------> SPI3_MOSI
    */
    GPIO_InitStruct.Pin = SCK3_Pin|MOSI3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MISO3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(MISO3_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, IMU_SCK_Pin|IMU_MISO_Pin|IMUMOSI_Pin);
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, ALT_SCK_Pin|ALT_MISO_Pin|ALT_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    PB5     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, SCK3_Pin|MISO3_Pin|MOSI3_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART3)
  {
    ...
    PC11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOC, PI_UART_TX_Pin|PI_UART_RX_Pin);
